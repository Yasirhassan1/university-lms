                ...
                <form action="" className="p-8 shadow bg-white rounded-lg mt-4">
                    <div className="cont flex gap-6 justify-between flex-wrap">
                        <div className="flex flex-col gap-2 w-full">
                            <label htmlFor="search-input">Search tags or keywords</label>
                            <input
                                id="search-input"
                                type="text"
                        ...
                        <div className="flex flex-col gap-2 w-full">
                            ...
                            <input id="publisher-input" type="text" placeholder="Unknown" className="p-4 rounded-lg border border-gray-200 w-full" />
                        </div>
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                {
                    search.length == 0 ?
                        (
                            bookData.map((cur) => {
                                return <Card key={cur.id} title={cur.title} author={cur.author} tags={cur.tags} />
                            })
                        ) :
                        (
                            bookData.filter((cur) => {
